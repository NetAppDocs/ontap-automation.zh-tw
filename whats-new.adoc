...
安全性:: ONTAP 9.18.1 REST API 引進了多項安全性增強功能。您可以使用新的叢集網路端點來顯示和更新叢集網路安全性組態，包括憑證管理。此外，您還可以管理 NVLog 流量的 HA 網路安全性組態。Autonomous Ransomware Protection（ARP）已增強，可讓您顯示和更新啟用功能。
